                            ...
                            <div className="movie-img sticky-sb">
                                ...
                                <div className="movie-btn">
                                    <div className="btn-transform transform-vertical red">
                                        ...
                                        <div>
                                            {/* <Link to={"https://www.youtube.com/embed/" + movie.trailer} className="item item-2 redbtn fancybox-media hvr-grow"><i className="ion-play"></i></Link> */}
                                            <button onClick={openModal} className="item item-2 redbtn fancybox-media hvr-grow"><i className="ion-play"></i></button>
                                                    
                                            {/* <a href={"https://www.youtube.com/embed/" + movie.trailer} className="item item-2 redbtn fancybox-media hvr-grow">
                                    ...
                                    <div className="btn-transform transform-vertical">
                                        <div>
                                            <a href="#" className="item item-1 redbtn"> <i className="ion-play"></i> Watch Movie</a>
                                            </div>
                                        <div>
                                            <Link to={movie.trailer} className="item item-2 redbtn fancybox-media hvr-grow"><i className="ion-play"></i></Link>
                                            {/* <button onClick={openModal} className="item item-2 redbtn fancybox-media hvr-grow"><i className="ion-play"></i></button> */}
                                                ...
                                                <div className="row">
                                                                    ...
                                                                    return (
                                                                        <div className="cast-it">
                                                                            <div className="cast-left">
                                                                                ...
                                                                                <Link to={`/celebrity/${item.id}`}>{item.name}</Link>
                                                    ...
                                                    <div className="col-md-4 col-xs-12 col-sm-12">
                                                        <div className="sb-it">
                                                            ...
                                                            {/* <p>
                                                                {
                                                                    movie.directors.length > 0 && movie.directors.map((actor, i) => {
                                                                        return (
                                                                            <a href="#">{actor}, </a>
                                                                        )
                                                                    })
                                                        ...
                                                        <div className="sb-it">
                                                            ...
                                                            {/* <p>
                                                                {
                                                                    movie.writer.length > 0 && movie.writer.map((actor, i) => {
                                                                        return (
                                                                            <a href="#">{actor}, </a>
                                                                        )
                                                                    })
                                                            ...
                                                            <p>
                                                                {
                                                                    actors && actors.length > 0 && actors.map((item, index) => {
                                                                        return (
                                                                            <Link key={(index + 1) * 44} to={`/celebrity/${item.id}`}>{item.name}, </Link>
                                                                        )
                                                                    })
                                                                }
                                                            </p>
                                                        ...
                                                        <div className="sb-it">
                                                            ...
                                                            {/* <p>
                                                                {
                                                                    movie.genres.length > 0 && movie.genres.map((actor, i) => {
                                                                        return (
                                                                            <a href="#">{actor}, </a>
                                                                        )
                                                                    })
                                                        ...
                                                        <div className="sb-it">
                                                            ...
                                                            <p>
                                                                {movie && movie.type === "series" ? (
                                                                    <span>{movie.runtime} min/ 1 episode</span>
                                                                ) : (
                                                        ...
                                                        <div className="sb-it">
                                                            ...
                                                            <p className="tags">
                                                                {/* {
                                                                    movie && movie.genres.length > 0 && movie.genres.map((item, index) => {
                                                                        return (
                                                                            <span key={index*23} className="time"><a href="#">{item}</a></span>
                                                                        )
                                                                    })
                                                                } */}
